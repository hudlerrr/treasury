...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      `}</style>
      <header className="px-4 lg:px-6 h-16 flex items-center bg-[#c0c0c0] border-b-2 border-[#ffffff] shadow-[inset_-1px_-1px_#0a0a0a,inset_1px_1px_#dfdfdf,inset_-2px_-2px_grey,inset_2px_2px_#fff]">
        <Link className="flex items-center justify-center" href="#">
          <Wallet className="h-8 w-8 text-yellow-600" />
          <span className="ml-2 text-xl font-bold">TreasureCorp</span>
        </Link>
        <nav className="ml-auto flex gap-4 sm:gap-6">
          <Button className="bg-[#c0c0c0] text-black border-2 shadow-[inset_-1px_-1px_#0a0a0a,inset_1px_1px_#dfdfdf,inset_-2px_-2px_grey,inset_2px_2px_#fff] hover:bg-[#d0d0d0] hover:rounded-lg transition-all duration-200">Connect Wallet</Button>
        </nav>
      </header>
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-br from-white to-gray-100 relative overflow-hidden">
          ...
          <div className="container space-y-12 px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-gray-800">Financial Clarity. Smarter Decisions.</h2>
            ...
            <div className="mx-auto grid items-start gap-0 sm:max-w-4xl sm:grid-cols-2 md:gap-0 lg:max-w-5xl lg:grid-cols-2 border-t border-l border-gray-200">
              <div className="grid gap-1 p-6 border-r border-b border-gray-200 bg-gray-50">
                <h3 className="text-lg font-bold text-gray-800">Real-Time Treasury Overview</h3>
              ...
              <div className="grid gap-1 p-6 border-r border-b border-gray-200">
                <h3 className="text-lg font-bold text-gray-800">Proposal Tracking & Governance Integration</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="grid gap-1 p-6 border-r border-b border-gray-200">
                <h3 className="text-lg font-bold text-gray-800">Budgeting, Forecasting, and Dynamic Scenario Planning</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-50">
          <div className="container px-4 md:px-6">
            <div className="grid gap-10 sm:px-10 md:gap-16 md:grid-cols-2">
              <div className="space-y-4">
                <h2 className="lg:leading-tighter text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl xl:text-[3.4rem] 2xl:text-[3.75rem] text-gray-800">
                  Treasury Complexity Should Drive Growth, Not Confusion
                </h2>
                <Link
                  href="#"
              ...
              <div className="flex flex-col items-start space-y-4">
                <p className="mx-auto max-w-[700px] text-gray-600 md:text-xl/relaxed dark:text-gray-400">
        ...
        {/* <section className="w-full py-12 md:py-24 lg:py-32 bg-white overflow-hidden">
          <div className="container px-4 md:px-6 relative">
            <div className="max-w-3xl">
              <h3 className="text-base font-semibold mb-2 text-gray-600">ECOSYSTEM</h3>
              <h2 className="text-4xl font-bold mb-4 leading-tight text-gray-800">Supercharge your treasury with integrations</h2>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-50">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-gray-800">Join our beta!</h2>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t bg-[#c0c0c0] border-t-2 border-[#ffffff] shadow-[inset_-1px_-1px_#0a0a0a,inset_1px_1px_#dfdfdf,inset_-2px_-2px_grey,inset_2px_2px_#fff]">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 TreasureCorp. All rights reserved.</p>
